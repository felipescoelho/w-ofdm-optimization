            ...
            for snrIndex = 1:length(snrValues)
                ...
                for channelIndex = 1:length(vehA200channel2)
                    ...
                    ber2A = ber2A + run_simulation(ensemble, ...
                        symbolsPerTx, bitsPerSubcar, numSubcar, ...
                        cpLength, csLength, windowLoader.optimizedWindowCaseAStep1, ...
                        vehA200channel2(channelIndex, :), ...
                        snrValues(snrIndex), tailTx, tailRx, ...
                        windowLoader.optimizedWindowCaseAStep2, prefixRemoval, ...
                        circularShift);
                    ber3A = ber3A + run_simulation(ensemble, ...
                        symbolsPerTx, bitsPerSubcar, numSubcar, ...
                        cpLength, csLength, windowLoader.optimizedWindowCaseAStep3, ...
                        vehA200channel2(channelIndex, :), ...
                        snrValues(snrIndex), tailTx, tailRx, ...
                        windowLoader.optimizedWindowCaseAStep2, prefixRemoval, ...
                        circularShift);
                    ...
                    ber1B = ber1B + run_simulation(ensemble, ...
                        ...
                        vehA200channel2(channelIndex, :), ...
                        snrValues(snrIndex), tailTx, tailRx, ...
                        windowLoader.optimizedWindowCaseBStep1, prefixRemoval, ...
                        circularShift);
                    ber2B = ber2B + run_simulation(ensemble, ...
                        symbolsPerTx, bitsPerSubcar, numSubcar, ...
                        cpLength, csLength, windowLoader.optimizedWindowCaseBStep2, ...
                        vehA200channel2(channelIndex, :), ...
                        snrValues(snrIndex), tailTx, tailRx, ...
                        windowLoader.optimizedWindowCaseBStep1, prefixRemoval, ...
                        circularShift);
                    ber3B = ber3B + run_simulation(ensemble, ...
                        ...
                        vehA200channel2(channelIndex, :), ...
                        snrValues(snrIndex), tailTx, tailRx, ...
                        windowLoader.optimizedWindowCaseBStep3, prefixRemoval, ...
                        circularShift);
                end
