        ...
        case {'wtx', 'CPwtx'}
            ...
            for cpIndex = 1:length(cpLengthVector)
                ...
                windowTx = load([folderName '/' ...
                    fileName]).optimizedTransmitterWindow;
        ...
        case {'wrx', 'CPwrx'}
            ...
            for cpIndex = 1:length(cpLengthVector)
                ...
                windowRx = load([folderName '/' ...
                    fileName]).optimizedReceiverWindow;
            ...
            save([folderToSave '/' fileToSave], 'rcWindowInterference', ...
                'optWindowInterference')
        case {'WOLA', 'CPW'}
            optWindowInterferenceRxStep1 = zeros(length(cpLengthVector), 1);
            optWindowInterferenceRxStep2 = zeros(length(cpLengthVector), 1);
            optWindowInterferenceRxStep3 = zeros(length(cpLengthVector), 1);
            optWindowInterferenceTxStep1 = zeros(length(cpLengthVector), 1);
            optWindowInterferenceTxStep2 = zeros(length(cpLengthVector), 1);
            optWindowInterferenceTxStep3 = zeros(length(cpLengthVector), 1);
            for cpIndex = 1:length(cpLengthVector)
                cpLength = cpLengthVector(cpIndex);
                [csLength, ~, ~] = calculate_parameters(typeOFDM, ...
                    cpLength, tailTx, tailRx);
                ...
                windowRxStep1 = windowLoader.optimizedReceiverStep1;
                windowRxStep2 = windowLoader.optimizedReceiverStep2;
                windowRxStep3 = windowLoader.optimizedReceiverStep3;
                windowTxStep1 = windowLoader.optimizedTransmitterStep1;
                windowTxStep2 = windowLoader.optimizedTransmitterStep2;
                windowTxStep3 = windowLoader.optimizedTransmitterStep3;
                optWindowInterferenceRxStep1(cpIndex) = ...
                    calculate_interference(cpLength, typeOFDM, ...
                    windowTxRC, windowRxStep1);
                optWindowInterferenceRxStep2(cpIndex) = ...
                    calculate_interference(cpLength, typeOFDM, ...
                    windowTxStep2, windowRxStep1);
                optWindowInterferenceRxStep3(cpIndex) = ...
                    calculate_interference(cpLength, typeOFDM, ...
                    windowTxStep2, windowRxStep3);
                optWindowInterferenceTxStep1(cpIndex) = ...
                    calculate_interference(cpLength, typeOFDM, ...
                    windowTxStep1, windowRxRC);
                optWindowInterferenceTxStep2(cpIndex) = ...
                    calculate_interference(cpLength, typeOFDM, ...
                    windowTxStep1, windowRxStep2);
                optWindowInterferenceTxStep3(cpIndex) = ...
                    calculate_interference(cpLength, typeOFDM, ...
                    windowTxStep3, windowRxStep2);
                rcWindowInterference(cpIndex) = ...
                    calculate_interference(cpLength, typeOFDM, ...
            ...
            fileToSave = strcat('interference_', typeOFDM);
            save([folderToSave '/' fileToSave], 'rcWindowInterference', ...
                'optWindowInterferenceTxStep1', ...
                'optWindowInterferenceTxStep2', ...
                'optWindowInterferenceTxStep3', ...
                'optWindowInterferenceRxStep1', ...
                'optWindowInterferenceRxStep2', ...
                'optWindowInterferenceRxStep3')
    end
end
